...
///     <see cref="GH_AsyncComponent{T}" /> needs to have one.
/// </summary>
    ...
    where T : GH_Component
{
    ...
    ///     <b>
    ///         Make sure you always check as frequently as you can if <see cref="WorkerInstance{T}.CancellationToken" /> is
    ///         cancelled. For an example, see the PrimeCalculatorWorker example.
    ///     </b>
    /// </summary>
    /// <remarks>
    ...
    ///     You can call <paramref name="done" /> on <see cref="Exception" />s, but avoid calling it when cancellation is has
    ///     been observed.
    /// </remarks>
    ...
    ///         <see cref="GH_AsyncComponent{T}" /> after you've called `Done` in the <see cref="DoWork" /> function.
    ///     </b>
    /// </summary>
    /// <param name="da"></param>
    ...
    ///     <b>Do not call this method directly. It will be invoked by the parent <see cref="GH_AsyncComponent{T}" />.</b>
    /// </summary>
    /// <param name="da"></param>
