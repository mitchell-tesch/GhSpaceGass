...
- [ ] **Slice 38** — Add a component for the query of Steel Design Results - List Steel Member Check Summary
- [ ] **Slice 39** — Zoom UI for analysis settings components (show common inputs by default, reveal all on zoom)
